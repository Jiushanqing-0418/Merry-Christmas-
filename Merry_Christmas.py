...
for x in x_position-x_seperation, x_position+x_seperation:
    make_circle(snowman, x, y_positions[0] + y_offset, 20, "gray")
...
hat.color("red")
hat.penup()
hat.setposition(x_position+20, y_positions[0]+y_offset*5)
hat.shape("triangle")
hat.setheading(70)
hat.turtlesize(5, 3)
make_circle(snowman, x+20, y_positions[0] + y_offset+72, 10, "white")
...
text.write("Merry Christmas", font=(
    "Apple Chancery", 24, "bold"), align="center")
text.setposition(130, 140)
text.color("dark green")
text.write("Jiu", font=("Avenir", 24, "bold"), align="right")
text.color("black")
text.write("Shanqing", font=("Avenir", 24, "normal"), align="left")
text.setx(60)
